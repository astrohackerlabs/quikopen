...
type LittleEndianValue = U16LE | U32LE | U64LE | U128LE | U256LE;
type BigEndianValue = U16BE | U32BE | U64BE | U128BE | U256BE;
interface WidthCase {
  bits: number;
  size: number;
  copyProbe: (writer: BufWriter, value: bigint) => LittleEndianValue;
  read: (reader: BufReader) => LittleEndianValue;
  write: (writer: BufWriter, value: bigint) => BufWriter;
  readBE: (reader: BufReader) => BigEndianValue;
  writeBE: (writer: BufWriter, value: bigint) => BufWriter;
}
